...
Project.prototype = {
	...
	,update: function() {
		if(this.player.up) {
			this.player.y -= Math.round(this.player.speed);
		} else if(this.player.down) {
			this.player.y += Math.round(this.player.speed);
		}
		if(this.player.left) {
			this.player.x -= Math.round(this.player.speed);
	...
	,bounds: function() {
		...
		if(this.player.x + this.player.get_width() >= 800) {
			this.player.x = 800 - this.player.get_width();
		}
		if(this.player.y + this.player.get_height() >= 600) {
			this.player.y = 600 - this.player.get_height();
		}
	}
...
kha_WebGLImage.prototype = $extend(kha_Image.prototype,{
	...
	,formatByteSize: function(format) {
		switch(format[1]) {
		case 0:
			return 4;
		case 1:
	...
	,lock: function(level) {
		...
		this.bytes = new haxe_io_Bytes(new ArrayBuffer(this.formatByteSize(this.format) * this.get_width() * this.get_height()));
		return this.bytes;
	}
	,unlock: function() {
		if(kha_SystemImpl.gl != null) {
			...
			case 1:
				...
				break;
			case 2:
				kha_SystemImpl.gl.texImage2D(3553,0,6408,this.get_width(),this.get_height(),0,6408,5126,new Float32Array(this.bytes.b.bufferValue));
				break;
			case 4:
				kha_SystemImpl.gl.texImage2D(3553,0,6408,this.get_width(),this.get_height(),0,6408,kha_SystemImpl.halfFloat.HALF_FLOAT_OES,new Float32Array(this.bytes.b.bufferValue));
				break;
			case 5:
				kha_SystemImpl.gl.texImage2D(3553,0,6406,this.get_width(),this.get_height(),0,6406,5126,new Float32Array(this.bytes.b.bufferValue));
				break;
			case 6:
				kha_SystemImpl.gl.texImage2D(3553,0,6406,this.get_width(),this.get_height(),0,6406,kha_SystemImpl.halfFloat.HALF_FLOAT_OES,new Float32Array(this.bytes.b.bufferValue));
				break;
			default:
				kha_SystemImpl.gl.texImage2D(3553,0,6408,this.get_width(),this.get_height(),0,6408,5121,new Uint8Array(this.bytes.b.bufferValue));
			}
